...
//  AccentMark
//
//  Created by Robert Millar on 7/11/13.
...
#define kNumAQBufs 5			// Number of audio queue buffers we allocate.
...
#define kAQDefaultBufSize 1024	// Number of bytes in each audio queue buffer
...
#define kAQMaxPacketDescs 32	// Number of packet descriptions in our array
...
@interface AudioStreamer : NSObject
{
	...
	double sampleRate;			// Sample rate of the file
	
    double packetDuration;		// sample rate times frames per packet
	double lastProgress;		// last calculated progress point
    
	BOOL vbr; // indicates VBR stream
}
